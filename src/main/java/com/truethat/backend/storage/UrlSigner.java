...
public class UrlSigner {
    ...
    private static final String clientAccount                 =
            System.getenv("GOOGLE_CLOUD_PROJECT") + "@appspot.gserviceaccount.com";
    // Default expiration is set to 24 hours
    private static final long   expirationMillis              = TimeUnit.DAYS.toMillis(1);
     ...
     */
    public static String getSignedUrl(@Nonnull String privateKey, @Nonnull String objectPath)
        ...
        long expiryTimeInSeconds = (System.currentTimeMillis() + expirationMillis) / 1000;
     ...
     * @return the signed URL, which can be used by the end user.
     */
    private static String buildUrl(String fullObjectPath, String signature, long expiredTimeInSeconds) {
